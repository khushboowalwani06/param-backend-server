    ...
    <View style={styles.card}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.valueText} numberOfLines={1}>{tDynamic(order.Name)}</Text>
          <Text style={styles.subText} numberOfLines={1}>{tDynamic(order.Company)}</Text>
        </View>

        <View style={styles.infoRow}>
          <Text style={styles.label}>{t('ITEMS')}</Text>
          <Text style={styles.valueText} numberOfLines={1}>{order.EstimateQty} {order.Unit || 'Bags'} • {tDynamic(order.Product)}</Text>
        </View>
